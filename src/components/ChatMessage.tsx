              ...
              <div className="mt-3 pt-3 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-2">
                  {message.citations.map((citation, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full text-xs font-medium cursor-pointer transition-colors duration-200"
                      title={citation.text}
                    >
